...
class HistorialApiView(views.APIView):
    ...
    def get(self, request):
        ...
        tratamientos = TratamientoPaciente.objects.filter(paciente__id = paciente.id)
        historic_data['tratamientos'] = TratamientoPacienteSerializer(tratamientos, many=True).data if tratamientos.exists() else None
